...
class TaxiEnv(Env):
    ...
    * v0: Initial versions release
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.locs = locs = [(0, 0), (0, 4), (4, 0), (4, 3)] #3120
    ...
    def _render_gui(self, mode):
        ...
        if self.taxi_imgs is None:
            file_names = [
                path.join(path.dirname(__file__), "img/car.png"),
                path.join(path.dirname(__file__), "img/car.png"),
                path.join(path.dirname(__file__), "img/car.png"),
                path.join(path.dirname(__file__), "img/car.png"),
            ]
...
for i in range(1, 10001):
    ...
    while not done:
        ...
        next_max = np.max(q_table[next_state,:]) - q_table[state, action]
